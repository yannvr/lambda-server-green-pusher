...
# Warm up function
curl -H "cypress: 42" -H "meonly: 1" https://greenlife-quote-pusher.yannvr.now.sh/api/warmup
...
curl -H "cypress: 42" -H "meonly: 1" https://greenlife-quote-pusher.yannvr.now.sh/api/broadcast-quote
